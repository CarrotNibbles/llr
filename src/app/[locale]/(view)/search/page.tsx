    ...
    <div className="flex flex-col w-full max-w-screen-xl px-4 py-1">
      <div className="px-4 mt-2 mb-8">
        ...
        {queried && paramsValid && (
          <>
            <StrategyTable
              dataPromise={buildStrategiesDataQuery(supabase, { q, raid, patch, page, limit, sort, jobs })}
            />
            <div className="w-full flex flex-col-reverse xl:grid xl:grid-cols-3 gap-y-2 mt-2">
              <div />
              <ViewPagination currentPage={page} dataPromise={buildMaxPageQuery(supabase, limit, { q, raid, patch })} />
