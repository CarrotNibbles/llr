...
2.	**Service Definition**: LLR is the service for creating, modifying, and sharing Final Fantasy XIV 'strats'.
...
9.	**Copyright**: Users retain copyright for 'strats' they create, but other intellectual property related to the service belongs to the operator.
